/*=========================================================================
 ...
 Program:   mipx
 Module:    vmxGUIInteractorStyleImage.h
...
#if defined(vmxGUIInteractorStyleImage_USE_SOURCE_CODE) || defined(vmxCore_USE_SOURCE_CODE)
    #define vmxGUIInteractorStyleImage_API
#else
    #if defined(_MSC_VER)
        #ifdef vmxGUIInteractorStyleImage_EXPORTS
            #define vmxGUIInteractorStyleImage_API __declspec(dllexport)
        #else
            #define vmxGUIInteractorStyleImage_API __declspec(dllimport)
        #endif
    #else
        #ifdef vmxGUIInteractorStyleImage_EXPORTS
            #define vmxGUIInteractorStyleImage_API __attribute__((visibility("default")))
        #else
            #define vmxGUIInteractorStyleImage_API
        #endif
    #endif
...
#ifndef vmxGUIInteractorStyleImage_H
	#define vmxGUIInteractorStyleImage_H
...
class vmxGUIInteractorStyleImage : public vtkInteractorStyleImage
{
...
public:
    ...
    /// Constructor.
    vmxGUIInteractorStyleImage();

    /// Destructor.
    virtual ~vmxGUIInteractorStyleImage();
    
    /// Check if double click was performed.
    int IsDoubleClicked(){ return m_is_double_clicked; };
    
    /// Create new object instance.
    static vmxGUIInteractorStyleImage* New();
