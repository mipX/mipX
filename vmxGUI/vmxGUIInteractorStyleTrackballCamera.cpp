/*=========================================================================
 ...
 Program:   mipx
 Module:    vmxGUIInteractorStyleTrackballCamera.cpp
...
int vmxGUIInteractorStyleTrackballCamera::EventDoubleClick = vtkCommand::UserEvent + 1;


vmxGUIInteractorStyleTrackballCamera::vmxGUIInteractorStyleTrackballCamera()
{
...
vmxGUIInteractorStyleTrackballCamera* vmxGUIInteractorStyleTrackballCamera::New()
{
    return new vmxGUIInteractorStyleTrackballCamera;
}


//void vmxGUIInteractorStyleTrackballCamera::OnMouseMove()
//{
...
void vmxGUIInteractorStyleTrackballCamera::OnMouseWheelBackward()
{
...
void vmxGUIInteractorStyleTrackballCamera::OnMouseWheelForward()
{
...
void vmxGUIInteractorStyleTrackballCamera::OnLeftButtonUp()
{
    m_is_left_button_down = 0;
...
void vmxGUIInteractorStyleTrackballCamera::OnLeftButtonDown()
{
...
void vmxGUIInteractorStyleTrackballCamera::OnKeyPress()
{
    //get the keypress
    vtkRenderWindowInteractor *rwi = this->Interactor;
