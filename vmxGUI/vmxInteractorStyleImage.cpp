/*=========================================================================
 ...
 Program:   mipx
 Module:    vmxInteractorStyleImage.cpp
...
int vmxInteractorStyleImage::EventDoubleClick = vtkCommand::UserEvent + 1;


vmxInteractorStyleImage::vmxInteractorStyleImage()
{
...
vmxInteractorStyleImage* vmxInteractorStyleImage::New()
{
    return new vmxInteractorStyleImage;
}


//void vmxInteractorStyleImage::OnMouseMove()
//{
...
void vmxInteractorStyleImage::OnLeftButtonUp()
{
    m_is_left_button_down = 0;
...
void vmxInteractorStyleImage::OnLeftButtonDown()
{
...
void vmxInteractorStyleImage::OnKeyPress()
{
    //get the keypress
    vtkRenderWindowInteractor *rwi = this->Interactor;
