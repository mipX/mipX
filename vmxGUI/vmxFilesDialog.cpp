...
vmxFilesDialogRenderWindowModifiedCallback::vmxFilesDialogRenderWindowModifiedCallback()
{
    m_is_active = 0;
    m_dialog = NULL;
...
void vmxFilesDialogRenderWindowModifiedCallback::SetDialog(vmxFilesDialog *dialog)
{
    m_is_active = 0;
    m_dialog = dialog;
}
...
vmxFilesDialogRenderWindowModifiedCallback* vmxFilesDialogRenderWindowModifiedCallback::New()
{
    return new vmxFilesDialogRenderWindowModifiedCallback;
}


void vmxFilesDialogRenderWindowModifiedCallback::Activate(int is_active)
{
    if(is_active)
    {
...
void vmxFilesDialogRenderWindowModifiedCallback::Execute(vtkObject *caller, unsigned long, void *)
{
    if(m_dialog)
    {
...
vmxFilesDialogInteractorLeftButtonDownCallback::vmxFilesDialogInteractorLeftButtonDownCallback()
{
    m_is_active = 0;
    m_dialog = NULL;
}
...
void vmxFilesDialogInteractorLeftButtonDownCallback::SetDialog(vmxFilesDialog *dialog)
{
    m_is_active = 0;
    m_dialog = dialog;
}
...
vmxFilesDialogInteractorLeftButtonDownCallback* vmxFilesDialogInteractorLeftButtonDownCallback::New()
{
    return new vmxFilesDialogInteractorLeftButtonDownCallback;
}


void vmxFilesDialogInteractorLeftButtonDownCallback::Activate(int is_active)
{
    if(is_active)
    {
        if(m_is_active) return;
...
void vmxFilesDialogInteractorLeftButtonDownCallback::Execute(vtkObject *caller, unsigned long, void *)
{
    if(m_dialog)
    {
        if(m_dialog->m_interactor)
        {
            ...
            {
                vmxFilesDialogItem *item = m_dialog->GetItem(index);
...
vmxFilesDialogInteractorMouseWheelBackwardCallback::vmxFilesDialogInteractorMouseWheelBackwardCallback()
{
    m_is_active = 0;
    m_dialog = NULL;
}
...
void vmxFilesDialogInteractorMouseWheelBackwardCallback::SetDialog(vmxFilesDialog *dialog)
{
    m_is_active = 0;
    m_dialog = dialog;
}
...
vmxFilesDialogInteractorMouseWheelBackwardCallback* vmxFilesDialogInteractorMouseWheelBackwardCallback::New()
{
    return new vmxFilesDialogInteractorMouseWheelBackwardCallback;
}


void vmxFilesDialogInteractorMouseWheelBackwardCallback::Activate(int is_active)
{
    if(is_active)
    {
        if(m_is_active) return;
...
void vmxFilesDialogInteractorMouseWheelBackwardCallback::Execute(vtkObject *caller, unsigned long, void *)
{
    if(m_dialog)
    {
        if(m_dialog->m_interactor)
...
vmxFilesDialogInteractorMouseWheelForwardCallback::vmxFilesDialogInteractorMouseWheelForwardCallback()
{
    m_is_active = 0;
    m_dialog = NULL;
}
...
void vmxFilesDialogInteractorMouseWheelForwardCallback::SetDialog(vmxFilesDialog *dialog)
{
    m_is_active = 0;
    m_dialog = dialog;
}
...
vmxFilesDialogInteractorMouseWheelForwardCallback* vmxFilesDialogInteractorMouseWheelForwardCallback::New()
{
    return new vmxFilesDialogInteractorMouseWheelForwardCallback;
}


void vmxFilesDialogInteractorMouseWheelForwardCallback::Activate(int is_active)
{
    if(is_active)
    {
        if(m_is_active) return;
...
void vmxFilesDialogInteractorMouseWheelForwardCallback::Execute(vtkObject *caller, unsigned long, void *)
{
    if(m_dialog)
    {
        if(m_dialog->m_interactor)
...
vmxFilesDialogInteractorKeyPressCallback::vmxFilesDialogInteractorKeyPressCallback()
{
    m_dialog = NULL;
    m_is_active = 0;
}
...
void vmxFilesDialogInteractorKeyPressCallback::SetDialog(vmxFilesDialog *dialog)
{
    m_dialog = dialog;
    m_is_active = 0;
}
...
vmxFilesDialogInteractorKeyPressCallback* vmxFilesDialogInteractorKeyPressCallback::New()
{
    return new vmxFilesDialogInteractorKeyPressCallback;
}


void vmxFilesDialogInteractorKeyPressCallback::Activate(int is_active)
{
    if(is_active)
    {
        if(m_is_active) return;
...
void vmxFilesDialogInteractorKeyPressCallback::Execute(vtkObject *caller, unsigned long, void *)
{
    //cout<<" key ";
    if(m_dialog)
    {
...
vmxFilesDialogItem::vmxFilesDialogItem()
{
    m_is_selected = 0;
    m_dialog = NULL;
}
...
vmxFilesDialog::vmxFilesDialog()
{
    ...
    m_window_modified_callback = vtkSmartPointer<vmxFilesDialogRenderWindowModifiedCallback>::New();
    m_window_modified_callback->SetDialog(this);
    m_left_button_down_callback = vtkSmartPointer<vmxFilesDialogInteractorLeftButtonDownCallback>::New();
    m_left_button_down_callback->SetDialog(this);
    m_mouse_wheel_backward_callback = vtkSmartPointer<vmxFilesDialogInteractorMouseWheelBackwardCallback>::New();
    m_mouse_wheel_backward_callback->SetDialog(this);
    m_mouse_wheel_forward_callback = vtkSmartPointer<vmxFilesDialogInteractorMouseWheelForwardCallback>::New();
    m_mouse_wheel_forward_callback->SetDialog(this);
    m_key_press_callback = vtkSmartPointer<vmxFilesDialogInteractorKeyPressCallback>::New();
...
vmxFilesDialog* vmxFilesDialog::New()
{
    return new vmxFilesDialog;
}


vmxFilesDialogItem* vmxFilesDialog::AddItem(const char *item_text)
{
    if(!item_text) return NULL;
    vmxFilesDialogItem *item = this->m_items.AddNewToEnd();
    item->m_dialog = this;
...
void vmxFilesDialog::BuildDialog()
{
    ...
    mxListIterator<vmxFilesDialogItem> it;
...
void vmxFilesDialog::GetColor(double &r, double &g, double &b)
{
    m_text_actor->GetTextProperty()->GetColor(r,g,b);
}


int vmxFilesDialog::GetOriginOfDialog(int &origin1, int &origin2)
{
...
int vmxFilesDialog::GetOriginOfTextActor(int &origin1, int &origin2)
{
...
int vmxFilesDialog::GetPickedItemIndex(int pos1, int pos2)
{
...
int vmxFilesDialog::GetSizeOfDialog(int &output_size1, int &output_size2)
{
...
int vmxFilesDialog::GetSizeOfTextActor(int &output_size1, int &output_size2)
{
...
int vmxFilesDialog::GetSizeOfUserTextActor(int &output_size1, int &output_size2)
{
    if(!m_interactor) return 0;
...
int vmxFilesDialog::GetSizeOfPathActor(int &output_size1, int &output_size2)
{
    if(!m_interactor) return 0;
...
int vmxFilesDialog::GetRenderWindowAvailableSize(int &output_size1, int &output_size2)
{
    if(!m_interactor) return 0;
...
int vmxFilesDialog::GetVisibility()
{
    return m_text_actor->GetVisibility();
}


int vmxFilesDialog::IsDialogPicked(int pos1, int pos2)
{
    int dialog_size[2];
...
int vmxFilesDialog::IsMultipleItemsSelected()
{
    int c = 0;
...
int vmxFilesDialog::IsTextActorPicked(int pos1, int pos2)
{
    int actor_size[2];
...
void vmxFilesDialog::ListenForLeftButtonDownEvent(int is_listening)
{
    m_left_button_down_callback->Activate(is_listening);
}


void vmxFilesDialog::ListenForRenderWindowModifiedEvent(int is_listening)
{
    m_window_modified_callback->Activate(is_listening);
}


void vmxFilesDialog::ListenForMouseWheelBackwardEvent(int is_listening)
{
    m_mouse_wheel_backward_callback->Activate(is_listening);
}


void vmxFilesDialog::ListenForMouseWheelForwardEvent(int is_listening)
{
    m_mouse_wheel_forward_callback->Activate(is_listening);
}


void vmxFilesDialog::ListenForKeyPressEvent(int is_listening)
{
    m_key_press_callback->Activate(is_listening);
}


void vmxFilesDialog::RedoPlacement()
{
//    if(m_placement==FREE)
//    {
//        
...
void vmxFilesDialog::SelectSingleItem(unsigned int item_index)
{
...
void vmxFilesDialog::SetColor(double r, double g, double b)
{
...
void vmxFilesDialog::SetFontSize(double font_size)
{
...
void vmxFilesDialog::SetInteractor(vtkRenderWindowInteractor *interactor)
{
...
void vmxFilesDialog::SetOrigin(int origin1, int origin2)
{
...
//void vmxFilesDialog::SetPlacementToCenterLeft()
//{
...
//void vmxFilesDialog::SetPlacementToCenterRight()
//{
...
void vmxFilesDialog::SetPlacementToLowerCenter()
{
...
void vmxFilesDialog::SetPlacementToLowerLeft()
{
    this->SetOrigin(0,0);
...
void vmxFilesDialog::SetPlacementToLowerRight()
{
    int *window_size = m_interactor->GetRenderWindow()->GetSize();
    int dialog_size[2];
    this->GetSizeOfDialog(dialog_size[0], dialog_size[1]);
...
void vmxFilesDialog::SetPlacementToRelative(unsigned int x_percent, unsigned int y_percent)
{
...
void vmxFilesDialog::SetPlacementToUpperCenter()
{
...
void vmxFilesDialog::SetPlacementToUpperLeft()
{
    int *window_size = m_interactor->GetRenderWindow()->GetSize();
    int dialog_size[2];
    this->GetSizeOfDialog(dialog_size[0], dialog_size[1]);
...
void vmxFilesDialog::SetPlacementToUpperRight()
{
    int *window_size = m_interactor->GetRenderWindow()->GetSize();
    int dialog_size[2];
    this->GetSizeOfDialog(dialog_size[0], dialog_size[1]);
...
void vmxFilesDialog::SetVisibility(int is_visible)
{
...
int vmxFilesDialog::ShowTextItems(int offset)
{
...
int vmxFilesDialog::OpenFiles(const char *directory_path)
{
   // m_selection_type = OPEN_FILES;
    ...
    {
        cout<<"vmxFilesDialog::Start(): Error opening file";
        tinydir_close(&dir);
        return 0;
    }
    ...
    for(int i=dir.n_files-1; i>=0; i--)
    {
        ...
        {
            cout<<endl<<"vmxFilesDialog::Start(): Error getting file";
            tinydir_close(&dir);
            return 0;
        }
        else
