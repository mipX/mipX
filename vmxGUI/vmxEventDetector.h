...
#if defined(vmxEventDetector_USE_SOURCE_CODE) || defined(vmxCore_USE_SOURCE_CODE)
    #define vmxEventDetector_API
#else
    #if defined(_MSC_VER)
        #ifdef vmxEventDetector_EXPORTS
            #define vmxEventDetector_API __declspec(dllexport)
        #else
            #define vmxEventDetector_API __declspec(dllimport)
        #endif
    #else
        #ifdef vmxEventDetector_EXPORTS
            #define vmxEventDetector_API __attribute__((visibility("default")))
        #else
            #define vmxEventDetector_API
        #endif
    #endif
...
#ifndef vmxEventDetector_H
	#define vmxEventDetector_H
...
class vmxEventDetector_API vmxDoubleClickDetector
{
...
class vmxEventDetector_API vmxMouseDragDetector
{
...
class vmxEventDetector_API vmxItemSelectionDetector
{
